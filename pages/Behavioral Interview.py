...
with col2:
    st.write("")
st.markdown(f"""# Welcome to Behavioral Interview!""",unsafe_allow_html=True)

st.markdown("""\n""")
jd = st.text_area("""Please add the job description here (if you don't have one, use keywords like "Decision making" or "Leadership" instead): """)
auto_play = st.checkbox("Check this box, If you want AI interviewer to speak! (Please don't change during the interview)")

@dataclass
class Message:
    '''dataclass for keep track of the messages'''
...
def initialize_session_state():
    ...
    if "history" not in st.session_state:
        ...
        st.session_state.history.append(Message("ai", "Hello! I will be interviewing you today. I'll be asking you a set of questions to evaluate your soft skills. Okay, let's get going! Would you kindly introduce yourself or say hello first?. Note: You may only answer with a maximum length of 4097 tokens!"))
    # token count
